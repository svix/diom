    ...
    (
        ...
        $crate::__reexports::pastey::paste! {
            ...
            where
                Self: 'static,
            {
                fn apply(self, state: $state_type, ctx: &::diom_operations::OpContext) -> Self::Response;
            }
            ...
            impl $module_op_name {
                pub fn apply(self, state: $state_type, ctx: &::diom_operations::OpContext) -> $response_name {
                    match self {
    ...
    (
        ...
        $crate::__reexports::pastey::paste! {
            ...
            where
                Self: 'static,
            {
                async fn apply(self, state: $state_type, ctx: &::diom_operations::OpContext) -> Self::Response;
            }
            ...
            impl $module_op_name {
                pub async fn apply(self, state: $state_type, ctx: &::diom_operations::OpContext) -> $response_name {
                    match self {
