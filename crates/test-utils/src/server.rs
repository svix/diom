...
pub fn default_server_config(workdir: &Path) -> ConfigurationInner {
    ...
    ConfigurationInner {
        ...
        cluster: ClusterConfiguration {
            ...
            connection_timeout: DurationMs::from(50),
            heartbeat_interval: DurationMs::from(50),
            election_timeout_min: DurationMs::from(100),
            election_timeout_max: DurationMs::from(300),
            auto_initialize: true,
            discovery_request_timeout: DurationMs::from_secs(3),
            discovery_timeout: DurationMs::from_secs(10),
            secret: None,
            seed_nodes: vec![],
            replication_request_timeout: DurationMs::from_secs(3),
            startup_discovery_delay: DurationMs::from(0),
            log_index_interval: DurationMs::from(500),
            snapshot_after_writes: None,
            snapshot_after_time: None,
            log_sync_interval_commits: 1,
            log_sync_interval_duration: DurationMs::from_millis(5),
            log_sync_interval_auto: false,
            log_sync_mode: SyncMode::Buffer,
            shut_down_on_go_away: true,
            replication_lag_threshold: 1_000_000,
            send_snapshot_timeout: DurationMs::from_secs(3),
        },
