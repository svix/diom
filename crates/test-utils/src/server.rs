...
pub fn default_server_config(workdir: &Path) -> ConfigurationInner {
    ...
    ConfigurationInner {
        ...
        opentelemetry: OpenTelemetryConfig {
            ...
            metrics_period: NonZeroDurationMs::from_secs(10).unwrap(),
            sample_ratio: None,
        ...
        cluster: ClusterConfiguration {
            ...
            connection_timeout: NonZeroDurationMs::from_millis(50).unwrap(),
            heartbeat_interval: NonZeroDurationMs::from_millis(50).unwrap(),
            election_timeout_min: NonZeroDurationMs::from_millis(100).unwrap(),
            election_timeout_max: NonZeroDurationMs::from_millis(300).unwrap(),
            auto_initialize: true,
            discovery_request_timeout: NonZeroDurationMs::from_secs(3).unwrap(),
            discovery_timeout: NonZeroDurationMs::from_secs(10).unwrap(),
            secret: None,
            seed_nodes: vec![],
            replication_request_timeout: NonZeroDurationMs::from_secs(3).unwrap(),
            startup_discovery_delay: DurationMs::from(0),
            log_index_interval: NonZeroDurationMs::from_millis(500).unwrap(),
            snapshot_after_writes: None,
            snapshot_after_time: None,
            log_sync_interval_commits: 1,
            log_sync_interval_duration: NonZeroDurationMs::from_millis(5).unwrap(),
            log_sync_interval_auto: false,
            log_sync_mode: SyncMode::Buffer,
