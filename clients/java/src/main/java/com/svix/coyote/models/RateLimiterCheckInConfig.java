...
@ToString
@EqualsAndHashCode
public abstract class RateLimiterCheckInConfig {
    @JsonIgnore
    ...
    public static class TokenBucket extends RateLimiterCheckInConfig {
    ...
    public static class FixedWindow extends RateLimiterCheckInConfig {
    ...
    private interface TypeFactory {
        RateLimiterCheckInConfig create(JsonNode config);
    }
    ...
    public static RateLimiterCheckInConfig fromTypeAndConfig(String type, JsonNode config) {
