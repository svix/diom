...
public class RateLimitGetNamespaceOut {
    ...
    *
    ...
    public RateLimitGetNamespaceOut maxStorageBytes(Long maxStorageBytes) {
    ...
    *
    ...
    public RateLimitGetNamespaceOut storageType(StorageType storageType) {
    ...
    *
    ...
    /**
     * Convert an instance of RateLimitGetNamespaceOut to an JSON string
     *
     * @return JSON string
     */
