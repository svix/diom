...
public class ClusterRemoveNodeOut {
    ...
    *
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to ClusterRemoveNodeOut
     */
    public static ClusterRemoveNodeOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, ClusterRemoveNodeOut.class);
    }
