...
public KvCreateNamespaceIn () {}
 ...
 public KvCreateNamespaceIn name(String name) {
    ...
    *
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to KvCreateNamespaceIn
     */
    public static KvCreateNamespaceIn fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, KvCreateNamespaceIn.class);
    }
