...
export interface RateLimiterCreateNamespaceOut {
    name: string;
...
export const RateLimiterCreateNamespaceOutSerializer = {
    // biome-ignore lint/suspicious/noExplicitAny: intentional any
    _fromJsonObject(object: any): RateLimiterCreateNamespaceOut {
        return {
            name: object['name'],
    ...
    // biome-ignore lint/suspicious/noExplicitAny: intentional any
    _toJsonObject(self: RateLimiterCreateNamespaceOut): any {
        return {
            'name': self.name,
