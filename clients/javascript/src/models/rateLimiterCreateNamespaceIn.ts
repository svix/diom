...
export interface RateLimiterCreateNamespaceIn {
    name: string;
    storageType?: StorageType;
    maxStorageBytes?: number | null;
}

export const RateLimiterCreateNamespaceInSerializer = {
    // biome-ignore lint/suspicious/noExplicitAny: intentional any
    _fromJsonObject(object: any): RateLimiterCreateNamespaceIn {
        return {
            name: object['name'],
    ...
    // biome-ignore lint/suspicious/noExplicitAny: intentional any
    _toJsonObject(self: RateLimiterCreateNamespaceIn): any {
        return {
            'name': self.name,
