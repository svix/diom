...
impl From<QueueSendOptions> for coyote_client::api::QueueSendOptions {
...
impl From<QueueReceiveOptions> for coyote_client::api::QueueReceiveOptions {
...
impl From<QueueAckOptions> for coyote_client::api::QueueAckOptions {
...
impl From<QueueNackOptions> for coyote_client::api::QueueNackOptions {
...
impl From<QueueRejectOptions> for coyote_client::api::QueueRejectOptions {
...
impl From<QueuePurgeOptions> for coyote_client::api::QueuePurgeOptions {
...
impl From<QueueStatsOptions> for coyote_client::api::QueueStatsOptions {
...
pub enum QueueCommands {
    ...
    Send {
        queue_send_in: crate::json::JsonOf<coyote_client::models::QueueSendIn>,
        #[clap(flatten)]
        options: QueueSendOptions,
    },
    /// Receive messages from the queue
    Receive {
        queue_receive_in: crate::json::JsonOf<coyote_client::models::QueueReceiveIn>,
        #[clap(flatten)]
        options: QueueReceiveOptions,
    },
    /// Acknowledge successful message processing
    Ack {
        queue_ack_in: crate::json::JsonOf<coyote_client::models::QueueAckIn>,
        #[clap(flatten)]
        options: QueueAckOptions,
    },
    /// Negative acknowledge - return message to queue or move to DLQ
    Nack {
        queue_nack_in: crate::json::JsonOf<coyote_client::models::QueueNackIn>,
        #[clap(flatten)]
        options: QueueNackOptions,
    },
    /// Reject a message - remove from processing and send to DLQ without retry
    Reject {
        queue_reject_in: crate::json::JsonOf<coyote_client::models::QueueRejectIn>,
        #[clap(flatten)]
        options: QueueRejectOptions,
    },
    /// Purge all messages from a queue
    Purge {
        queue_purge_in: crate::json::JsonOf<coyote_client::models::QueuePurgeIn>,
        #[clap(flatten)]
        options: QueuePurgeOptions,
    },
    /// Get queue statistics
    Stats {
        queue_stats_in: crate::json::JsonOf<coyote_client::models::QueueStatsIn>,
        #[clap(flatten)]
