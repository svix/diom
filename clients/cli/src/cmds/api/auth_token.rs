...
pub enum AuthTokenCommands {
    ...
    /// Create Auth Token
    Create {
        auth_token_create_in: crate::json::JsonOf<coyote_client::models::AuthTokenCreateIn>,
    },
    /// Expire Auth Token
    Expire {
        auth_token_expire_in: crate::json::JsonOf<coyote_client::models::AuthTokenExpireIn>,
    },
    /// Delete Auth Token
    Delete {
        auth_token_delete_in: crate::json::JsonOf<coyote_client::models::AuthTokenDeleteIn>,
    },
    /// Verify Auth Token
    Verify {
        auth_token_verify_in: crate::json::JsonOf<coyote_client::models::AuthTokenVerifyIn>,
    },
    /// List Auth Tokens
    List {
        auth_token_list_in: crate::json::JsonOf<coyote_client::models::AuthTokenListIn>,
    },
    /// Update Auth Token
    Update {
