...
This is a multimodal, clustered database being developed by [Svix](https://www.svix.com).

## Developing

This application is written in Rust and targets the latest stable release of Rust. You should install Rust with `rustup` or your favorite package manager.
