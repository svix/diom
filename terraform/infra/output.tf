...
output "client_prefix" {
  value = random_pet.client_prefix.id
}

output "vpc_id" {
  value = module.diom_aws.vpc_id
}

output "vpc_cidr" {
  value = module.diom_aws.vpc_cidr
}

output "public_subnets" {
  value = module.diom_aws.public_subnets
}

output "private_subnets" {
  value = module.diom_aws.private_subnets
}

output "database_subnets" {
  value = module.diom_aws.database_subnets
}

# eks
output "k8s_endpoint" {
  value = module.diom_aws.k8s_endpoint
}

output "k8s_cluster_id" {
  value = module.diom_aws.k8s_cluster_id
}

output "k8s_cluster_name" {
  value = module.diom_aws.k8s_cluster_name
}

output "k8s_oidc_issuer" {
  value = module.diom_aws.k8s_oidc_issuer
}

output "k8s_cluster_certificate_authority_data" {
  value = module.diom_aws.k8s_cluster_certificate_authority_data
}

output "k8s_oidc_provider_arn" {
  value = module.diom_aws.k8s_oidc_provider_arn
}
