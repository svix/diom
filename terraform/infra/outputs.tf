...
output "coyote_namespace" {
  value = var.coyote_namespace
}
...
# output "dns_zone_arns" {
#   value = module.coyote_aws.dns_zone_arns
# }

# output "svix_namespace" {
#   value = module.coyote_aws.coyote_namespace
# }
...
#   value = module.coyote_aws.api_domain_cert
# }

# output "app_domain_cert" {
#   value = module.coyote_aws.app_domain_cert
# }

# output "frontend_domain_cert" {
#   value = module.coyote_aws.frontend_domain_cert
# }
...
#   value = module.coyote_aws.alb_log_bucket
# }
