...
public class IdempotencyCreateNamespaceOut {
    ...
    *
    ...
    public IdempotencyCreateNamespaceOut created(Long created) {
    ...
    *
    ...
    public IdempotencyCreateNamespaceOut updated(Long updated) {
    ...
    *
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to IdempotencyCreateNamespaceOut
     */
    public static IdempotencyCreateNamespaceOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, IdempotencyCreateNamespaceOut.class);
    }
