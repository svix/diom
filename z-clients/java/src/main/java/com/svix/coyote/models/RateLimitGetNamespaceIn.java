...
public class RateLimitGetNamespaceIn {
    ...
    *
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to RateLimitGetNamespaceIn
     */
    public static RateLimitGetNamespaceIn fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, RateLimitGetNamespaceIn.class);
    }
