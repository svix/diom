...
public class KvSetOut {
    ...
    *
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to KvSetOut
     */
    public static KvSetOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, KvSetOut.class);
    }
