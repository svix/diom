...
public class KvGetIn_ {
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to KvGetIn_
     */
    public static KvGetIn_ fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, KvGetIn_.class);
    }
