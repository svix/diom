...
public class MsgTopicConfigureOut {
    ...
    *
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to MsgTopicConfigureOut
     */
    public static MsgTopicConfigureOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, MsgTopicConfigureOut.class);
    }
