...
public class KvGetNamespaceOut {
    ...
    *
    ...
    public KvGetNamespaceOut created(Long created) {
    ...
    *
    ...
    public KvGetNamespaceOut updated(Long updated) {
    ...
    *
    ...
    /**
     * Create an instance of KvGetNamespaceOut given a JSON string
     *
    ...
    /**
     * Convert an instance of KvGetNamespaceOut to a JSON string
     *
     * @return JSON string
     */
