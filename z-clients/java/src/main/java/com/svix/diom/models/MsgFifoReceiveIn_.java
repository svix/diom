...
public class MsgFifoReceiveIn_ {
    ...
    /**
     * Create an instance of MsgFifoReceiveIn_ given a JSON string
     *
     * @param jsonString JSON string
     * @return An instance of MsgFifoReceiveIn_
     * @throws JsonProcessingException if the JSON string is invalid with respect to MsgFifoReceiveIn_
     */
    public static MsgFifoReceiveIn_ fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, MsgFifoReceiveIn_.class);
    }

    /**
     * Convert an instance of MsgFifoReceiveIn_ to a JSON string
     *
     * @return JSON string
     */
