...
public class KvDeleteOut {
    ...
    *
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to KvDeleteOut
     */
    public static KvDeleteOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, KvDeleteOut.class);
    }
