...
public class RateLimitGetRemainingIn {
    ...
    *
    ...
    public RateLimitGetRemainingIn config(RateLimitConfig config) {
        this.config = config;
        return this;
    }
    ...
    *
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to RateLimitGetRemainingIn
     */
    public static RateLimitGetRemainingIn fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, RateLimitGetRemainingIn.class);
    }
