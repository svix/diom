...
public class IdempotencyGetNamespaceIn {
    ...
    *
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to IdempotencyGetNamespaceIn
     */
    public static IdempotencyGetNamespaceIn fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, IdempotencyGetNamespaceIn.class);
    }
