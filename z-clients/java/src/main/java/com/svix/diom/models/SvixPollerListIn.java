...
public class SvixPollerListIn {
    @JsonProperty private String namespace;
    @JsonProperty private Long limit;
    @JsonProperty private String iterator;
    public SvixPollerListIn() {}

    public SvixPollerListIn namespace(String namespace) {
    ...
    *
    ...
    public SvixPollerListIn limit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    *
    ...
    public SvixPollerListIn iterator(String iterator) {
