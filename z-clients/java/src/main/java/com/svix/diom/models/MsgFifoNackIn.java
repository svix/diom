...
public class MsgFifoNackIn {
    @JsonProperty private String namespace;
    @JsonProperty("msg_ids") private List<String> msgIds;
    public MsgFifoNackIn() {}

    public MsgFifoNackIn namespace(String namespace) {
    ...
    *
    ...
    public MsgFifoNackIn msgIds(List<String> msgIds) {
        this.msgIds = msgIds;
        return this;
    }

    public MsgFifoNackIn addMsgIdsItem(String msgIdsItem) {
        if (this.msgIds == null) {
