...
public class CacheDeleteOut {
    ...
    *
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to CacheDeleteOut
     */
    public static CacheDeleteOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, CacheDeleteOut.class);
    }
