...
public class CacheSetOut {
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to CacheSetOut
     */
    public static CacheSetOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, CacheSetOut.class);
    }
