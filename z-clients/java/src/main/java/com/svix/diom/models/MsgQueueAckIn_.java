...
public class MsgQueueAckIn_ {
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to MsgQueueAckIn_
     */
    public static MsgQueueAckIn_ fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, MsgQueueAckIn_.class);
    }
