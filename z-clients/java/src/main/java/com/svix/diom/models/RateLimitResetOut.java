...
public class RateLimitResetOut {
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to RateLimitResetOut
     */
    public static RateLimitResetOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, RateLimitResetOut.class);
    }
