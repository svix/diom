...
public class MsgNamespaceCreateOut {
    ...
    *
    ...
    public MsgNamespaceCreateOut retention(Retention retention) {
    ...
    *
    ...
    public MsgNamespaceCreateOut created(Long created) {
    ...
    *
    ...
    public MsgNamespaceCreateOut updated(Long updated) {
    ...
    *
     ...
     * @throws JsonProcessingException if the JSON string is invalid with respect to MsgNamespaceCreateOut
     */
    public static MsgNamespaceCreateOut fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, MsgNamespaceCreateOut.class);
    }
