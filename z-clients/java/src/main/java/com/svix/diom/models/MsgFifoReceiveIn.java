...
public class MsgFifoReceiveIn {
    ...
    public MsgFifoReceiveIn() {}

    public MsgFifoReceiveIn namespace(String namespace) {
    ...
    *
    ...
    public MsgFifoReceiveIn batchSize(Short batchSize) {
    ...
    *
    ...
    public MsgFifoReceiveIn leaseDuration(Duration leaseDuration) {
    ...
    *
    ...
    public MsgFifoReceiveIn batchWait(Duration batchWait) {
