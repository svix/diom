...
public class MsgFifoExtendLeaseIn {
    ...
    public MsgFifoExtendLeaseIn() {}

    public MsgFifoExtendLeaseIn namespace(String namespace) {
    ...
    *
    ...
    public MsgFifoExtendLeaseIn msgIds(List<String> msgIds) {
        this.msgIds = msgIds;
        return this;
    }

    public MsgFifoExtendLeaseIn addMsgIdsItem(String msgIdsItem) {
        if (this.msgIds == null) {
    ...
    *
    ...
    public MsgFifoExtendLeaseIn leaseDuration(Duration leaseDuration) {
