...
public class MsgFifoAckIn {
    @JsonProperty private String namespace;
    @JsonProperty("msg_ids") private List<String> msgIds;
    public MsgFifoAckIn() {}

    public MsgFifoAckIn namespace(String namespace) {
    ...
    *
    ...
    public MsgFifoAckIn msgIds(List<String> msgIds) {
        this.msgIds = msgIds;
        return this;
    }

    public MsgFifoAckIn addMsgIdsItem(String msgIdsItem) {
        if (this.msgIds == null) {
