...
export class AdminAuthToken {
    ...
    public create(
        ...
        const request = new CoyoteRequest(HttpMethod.POST, "/api/v1.admin.auth-token.create");
    ...
    public expire(
        ...
        const request = new CoyoteRequest(HttpMethod.POST, "/api/v1.admin.auth-token.expire");
    ...
    public rotate(
        ...
        const request = new CoyoteRequest(HttpMethod.POST, "/api/v1.admin.auth-token.rotate");
    ...
    public delete(
        ...
        const request = new CoyoteRequest(HttpMethod.POST, "/api/v1.admin.auth-token.delete");
    ...
    public list(
        ...
        const request = new CoyoteRequest(HttpMethod.POST, "/api/v1.admin.auth-token.list");
    ...
    public update(
        ...
        const request = new CoyoteRequest(HttpMethod.POST, "/api/v1.admin.auth-token.update");
    ...
    public whoami(
        ...
        const request = new CoyoteRequest(HttpMethod.POST, "/api/v1.admin.auth-token.whoami");
