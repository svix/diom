...
export class AdminAuthRole {
    ...
    public upsert(
        ...
        const request = new CoyoteRequest(HttpMethod.POST, "/api/v1.admin.auth-role.upsert");
    ...
    public delete(
        ...
        const request = new CoyoteRequest(HttpMethod.POST, "/api/v1.admin.auth-role.delete");
    ...
    public get(
        ...
        const request = new CoyoteRequest(HttpMethod.POST, "/api/v1.admin.auth-role.get");
    ...
    public list(
        ...
        const request = new CoyoteRequest(HttpMethod.POST, "/api/v1.admin.auth-role.list");
