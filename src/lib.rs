...
pub struct AppState {
    ...
    kv_store: diom_kv::KvStore,
    cache_store: crate::v1::modules::cache::CacheStore,
    rate_limiter: diom_rate_limiter::RateLimiter,
...
pub async fn run_with_prefix(cfg: Configuration, listener: Option<TcpListener>) {
    ...
    let app_state = AppState {
        cfg: cfg.clone(),
        db,
        kv_store: diom_kv::KvStore::default(),
        cache_store: crate::v1::modules::cache::CacheStore::new(diom_kv::KvStore::new(
            "cache_store",
        )),
        rate_limiter: diom_rate_limiter::RateLimiter::new(),
