...
Coyote msgs topics are backed by an ordered-stream, which provides a variety benefits, including: efficient writing, ordering, parallel-processing, and time-travel (restart processing for a specific point in time).
